...
class HttpRunner(object):
    ...
    def _add_tests(self, testcases):
        """ initialize testcases with Runner() and add to test suite.
        ...
        for testcase in testcases:
            ...
            for index, test_dict in enumerate(tests):
                ...
                for times_index in range(times):
                    # suppose one testcases should not have more than 9999 steps,
    ...
    def run_path(self, path, dot_env_path=None, mapping=None):
        """ run testcases/testsuites file or folder.
    ...
    def run(self, path_or_tests, dot_env_path=None, mapping=None):
        ...
        Args:
            path_or_tests:
                str: testcases/testsuites file/foler path
                dict: valid testcases/testsuites data
            dot_env_path (str): specified .env file path.
            mapping (dict): if mapping is specified, it will override variables in config block.
        ...
        if loader.is_test_path(path_or_tests):
            ...
            raise exceptions.ParamsError(f"Invalid testcases path or testcases: {path_or_tests}")
