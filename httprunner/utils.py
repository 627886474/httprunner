...
def get_testcase_io(testcase):
    """ get and print testcases input(variables) and output(export).
...
-
    ...
    testcases: path/to/demo_testcase.yml
    variables:
        device_sn: $device_sn
-
...
def prepare_log_file_abs_path(test_path: str, file_name: str) -> str:
    ...
    if not test_path:
        # running passed in testcases/testsuites data structure
