...
- check: validate api/testcases/testsuites data structure with JSON schema
- locate: locate debugtalk.py, make it's dir as project root path
- load: load testcases files and relevant data, including debugtalk.py, .env, yaml/json api/testcases, csv, etc.
- buildup: assemble loaded content to httprunner testcases/testsuites data structure
