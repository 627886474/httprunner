...
testcase_schema_v1_path = os.path.join(schemas_root_dir, "testcases.schema.v1.json")
testcase_schema_v2_path = os.path.join(schemas_root_dir, "testcases.schema.v2.json")
testsuite_schema_v1_path = os.path.join(schemas_root_dir, "testsuites.schema.v1.json")
testsuite_schema_v2_path = os.path.join(schemas_root_dir, "testsuites.schema.v2.json")
...
class JsonSchemaChecker(object):
    ...
    def validate_format(content, scheme):
        """ check api/testcases/testsuites format if valid
        """
        try:
...
def is_test_content(data_structure):
    ...
    if "apis" in data_structure:
        ...
        # maybe a testsuites, containing a group of testcases
